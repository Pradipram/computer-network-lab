...
// creating add server which will multiply two numbers and run on port 8002
#include <arpa/inet.h>
#include <bits/stdc++.h>
...
int main()
{
  ...
  if (serverSocket == -1)
  {
	...
	success("socker created successfully");
  ...
  if (listen(serverSocket, 5) == -1)
  {
	...
	success("multiplicaton server is running on port 8003");
